...
var filetype_list = $("div.filetype_contents").find("div.filetype_list")
var filetype_detail = $("div.filetype_contents").find("div.filetype_detail")
...
for (var i = 0; i<core.filetypes.length; i++) {
	...
	filetype_list.append("<div class="+extName+">"+extName+"</div>");
	$(".filetype_contents").find("."+extName).click(function () {
		...
		filetype_detail.append("<div style='width:100%;'>Extension Name</div>");
		filetype_detail.append("<div style='width:100%;'><input class='file_extension' style='width:200px;' value='"+$(this).attr("id")+"'></input></div>");
		filetype_detail.append("<div style='width:100%;'>Editor</div>");
		filetype_detail.append("<div style='width:100%;'><input class='editor' style='width:200px;' value='"+self.get_filetype_info($(this).attr("id"), "editor")+"'></input></div>");
		filetype_detail.append("<div style='width:100%;'>Type</div>");
		filetype_detail.append("<div style='width:100%;'><input class='type' style='width:200px;' value='"+self.get_filetype_info($(this).attr("id"), "type")+"'></input></div>");
		filetype_detail.append("<div style='width:100%;'>Description</div>");
		filetype_detail.append("<div style='width:100%;'><textarea class='description' style='resize: none; width:200px; height:100px; overflow:hidden;'>"+self.get_filetype_info($(this).attr("id"), "description")+"</textarea></div>");
	});
}
...
$("#add").click(function () {
	...
	$(".filetype_contents").find(".filetype_list").find(".newExt").click(function () {
		...
		if ($(this).hasClass("newExt")) {	
			...
			filetype_detail.append("<div style='width:100%;'><input class='file_extension' style='width:200px;' value=''></input></div>");
			filetype_detail.append("<div style='width:100%;'>Editor</div>");
			filetype_detail.append("<div style='width:100%;'><input class='editor' style='width:200px;' value=''></input></div>");
			filetype_detail.append("<div style='width:100%;'>Type</div>");
			filetype_detail.append("<div style='width:100%;'><input class='type' style='width:200px;' value=''></input></div>");
			filetype_detail.append("<div style='width:100%;'>Description</div>");
			filetype_detail.append("<div style='width:100%;'><textarea class='description' style='resize: none; width:200px; height:100px; overflow:hidden;'></textarea></div>");
		}
		else {
			filetype_detail.append("<div style='width:100%;'>Extention Name</div>");
			filetype_detail.append("<div style='width:100%;'><input class='file_extension' style='width:200px;' value='"+$(this).attr("id")+"'></input></div>");
