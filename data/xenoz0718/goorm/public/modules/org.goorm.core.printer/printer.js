...
/*global org: false, core: false, CodeMirror: false */
/*jshint unused: false */
...
org.goorm.core.printer = {
	...
	init: function () {
		...
		var handle_print = function (panel) {
		...
		this.buttons = [{
			id: "g_printer_btn_print",
			text: "<span localization_key='print'>Print</span>",
			handler: handle_print,
			isDefault: true
		}, {
			id: "g_printer_btn_cancel",
