! ✖ / env;
node;
var fs = require("fs"), path = require("path"), exists = fs.existsSync || path.existsSync, base = path.join(__dirname, "../../"), jsonOut = path.join(__dirname, "../", "js", "yui3.json"), jsOut = path.join(__dirname, "../", "js", "yui3.js"), MD5_TOKEN = "{ /* MD5 */ }", TEMPLATE_TOKEN = "{ /* METAGEN */ }", crypto = require("crypto"), md5 = function(str)  {
