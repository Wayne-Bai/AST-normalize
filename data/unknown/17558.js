...
;
   ...
   while (true)  {
         ...
         if (code == eoiCode) break         if (code < dict.length)  {
            if (last != clearCode)  {
...
;
console.log(lzwDecode(sg.blocks[1].lzwMinCodeSize, sgl));
