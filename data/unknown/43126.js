! ✖ / env;
node;
var program = require("commander"), express = require("express"), http = require("http"), https = require("https"), fs = require("fs"), path = require("path"), routes = require("./routes");
program.version(JSON.parse(fs.readFileSync(__dirname + "/package.json", "utf-8")).version).option("-b, --browser", "Open the app in a browser window").parse(process.argv);
var app = express();
