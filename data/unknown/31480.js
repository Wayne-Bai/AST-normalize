! ✖ / env;
node;
var request = require("request"), path = require("path"), fs = require("fs");
var files =  {
...
Object.keys(files).forEach(function(key)  {
      request(files[key], function(err, res, data)  {
            if (err || res.statusCode !== 200) return console.error("failed to update")            console.log("downloaded", files[key]);
