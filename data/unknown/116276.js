! ✖ / bin / silkjs;
var GitHub = require("GitHub").GitHub, ReadLine = require("ReadLine"), process = require("builtin/process"), fs = require("fs"), console = require("console");
var gh, stdin, alive = true;
