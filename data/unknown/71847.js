! ✖ / env;
node;
var models = require("../lib/server-models"), logger = require("../lib/logging").getLogger(), simConf = require("../simulatorConf.js").SERVER, UnhangoutDb = require("../lib/unhangout-db"), async = require("async"), _ = require("underscore");
var db;
