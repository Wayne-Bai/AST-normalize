! ✖ / env;
node;
var DebugServer = require("../lib/debug-server").DebugServer, fs = require("fs"), path = require("path"), Config = require("../lib/config"), packageJson = require("../package.json"), notifyParentProcess = getNotifyParentProcessFn();
...
function onError(err)  {
   console.error("Cannot start the server at %s:%s. Error: %s.", config.webHost, config.webPort, err.message || err);
