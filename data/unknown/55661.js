! ✖ / env;
node;
var async = require("async"), path = require("path"), platforms = require("../platforms"), fs = require("fs"), os = require("os"), SM = require("source-map"), _ = require("../Alloy/lib/alloy/underscore");
scan(path.join(__dirname, "..", "test", "projects", "Harness", "build", "map", "Resources"), ".map", function(err, files)  {
      _.map(files, function(sourceMapFile)  {
            ...
            var sourceMap = fs.readFileSync(sourceMapFile,  {
                  encoding:"utf8"               }
            ), lineArray = [];
