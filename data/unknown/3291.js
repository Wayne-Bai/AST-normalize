...
, log = console.log, dbg = debug ? console.log : emptyFn, test_utils = require("./deps/test-utils"), format = test_utils.format, Spade = require("../"), client = Spade(), collected = client.logger.collected, exit = typeof done === "function" ? done : function()  {
   }
