...
var fs = require("fs"), fname = process.argv[2] || "example", iter = process.argv[3] ? parseInt(process.argv[3], 10) : 100, transit = require("../target/transit.js"), r = transit.reader(), w = transit.writer(), jstr = fs.readFileSync("resources/" + fname + ".json", "utf-8");
