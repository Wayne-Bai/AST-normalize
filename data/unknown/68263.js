...
function(console, args, readFileFunc)  {
   var fileName, env, fs, vm, path, exec, rhinoContext, dir, nodeRequire, nodeDefine, exists, reqMain, loadedOptimizedLib, version = "1.0.7", jsSuffixRegExp = /\.js$/, commandOption = "", useLibLoaded =  {} , rhinoArgs = args, readFile = typeof readFileFunc !== "undefined" ? readFileFunc : null;
   function showHelp()  {
...
;
      optimize =  {
         ...
         jsFile:function(fileName, outFileName, config, moduleName, pluginCollector)  {
            var parts = config.optimize + "".split("."), optimizerName = parts[0], keepLines = parts[1] === "keepLines", fileContents;
