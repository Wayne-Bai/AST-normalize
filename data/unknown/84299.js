! ✖ / env;
node;
var swig = require("../index"), optimist = require("optimist"), fs = require("fs"), path = require("path"), filters = require("../lib/filters"), utils = require("../lib/utils"), uglify = require("uglify-js");
var command, argv = optimist.usage("
 Usage:
...
).alias("v", "version").alias("o", "output").default("o", "stdout").alias("h", "help").alias("j", "json").alias("c", "context").alias("m", "minify").default("wrap-start", "var tpl = ").default("wrap-end", ";").default("method-name", "tpl").check(function(argv)  {
      if (argv.v)  {
         return ;
      }
      if (! argv._.length)  {
...
).argv, ctx =  {} , out = function(file, str)  {
   console.log(str);
}
, efn = function()  {
}
