...
function()  {
   "use strict";
   var fs = require("fs"), https = require("https"), path = require("path"), spawn = require("child_process").spawn, zlib = require("zlib");
   var _ = require("../lodash.js"), mkdirpSync = require("./mkdirp-sync.js"), preprocess = require("./pre-compile.js"), postprocess = require("./post-compile.js"), tar = require("../vendor/tar/tar.js");
...
;
   function closureCompile(source, mode, callback)  {
      var filePath = this.filePath, isAdvanced = mode == "advanced", isMapped = this.isMapped, options = closureOptions.slice(), outputPath = this.outputPath, mapPath = getMapPath(outputPath), sourceMapURL = this.sourceMapURL || path.basename(mapPath);
