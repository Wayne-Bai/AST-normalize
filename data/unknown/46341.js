! ✖ / env;
node;
var paths = require("./parse"), json = paths.parse(), fs = require("fs"), path = require("path"), examples = [], tab = "    ", xml = path.join(__dirname, "../tests", "coverage.xml"), str = ["<?xml version="1.0"?>", "<!-- Dynamically generated by src/common/node/make_unit.js -->", "<yuitest>", tab + "<tests base="@TEST_ARTIFACTS_BASE@" timeout="240000">"];
