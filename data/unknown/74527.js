...
var assert = require("assert"), config = require("../../config/config"), BlockExtractor = require("../../lib/BlockExtractor"), networks = require("bitcore/networks"), util = require("bitcore/util/util");
      ...
      it.skip("should read 100000 blocks with no error ", function(done)  {
            ...
            while (i++ < 100000)  {
                  be.getNextBlock(function(err, b)  {
                        ...
                        if (i % 1000 === 1) process.stdout.write(".")                        if (i === 100000) done()                     }
                  );
               }
         }
      );
