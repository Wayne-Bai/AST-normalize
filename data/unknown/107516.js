...
function(console, args, readFileFunc)  {
   var fileName, env, fs, vm, path, exec, rhinoContext, dir, nodeRequire, nodeDefine, exists, reqMain, loadedOptimizedLib, version = "1.0.5", jsSuffixRegExp = /\.js$/, commandOption = "", useLibLoaded =  {} , rhinoArgs = args, readFile = typeof readFileFunc !== "undefined" ? readFileFunc : null;
   function showHelp()  {
...
;
      ...
      build.toTransport = function(anonDefRegExp, namespace, moduleName, path, contents, layer)  {
         return contents.replace(anonDefRegExp, function(match, start, callName, possibleComment, suffix, namedModule, namedFuncStart)  {
               ...
               return start + namespace + "define('" + namedModule || moduleName + "'," + deps ? "[" + deps.toString() + "]," : "" + namedModule ? namedFuncStart.replace(build.leadingCommaRegExp, "") : suffix;
            }
         );
      }
;
