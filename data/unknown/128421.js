...
;
         survey("Project info", project, function(project)  {
               ...
               fs.readFile(bundle + "/README.md", "utf8", function(err, data)  {
                     if (err) throw err                     write(path + "/README.md", parse(data, project));
                  }
               );
...
function createAll(path, project)  {
   ...
   fs.readFile(bundle + "/app.mus", "utf8", function(err, data)  {
         if (err) throw err         write(path + "/app.js", parse(data, project));
      }
   );
   mkdir(path + "/public", function()  {
         mkdir(path + "/public/js", function()  {
               fs.readFile(bundle + "/js/app.mus", "utf8", function(err, data)  {
                     if (err) throw err                     write(path + "/public/js/app.js", parse(data, project));
                  }
               );
               fs.readFile(bundle + "/js/controllers.mus", "utf8", function(err, data)  {
                     if (err) throw err                     write(path + "/public/js/controllers.js", parse(data, project));
                  }
               );
               fs.readFile(bundle + "/js/directives.mus", "utf8", function(err, data)  {
                     if (err) throw err                     write(path + "/public/js/directives.js", parse(data, project, ["<%", "%>"]));
                  }
               );
               fs.readFile(bundle + "/js/filters.mus", "utf8", function(err, data)  {
                     if (err) throw err                     write(path + "/public/js/filters.js", parse(data, project));
                  }
               );
               fs.readFile(bundle + "/js/services.mus", "utf8", function(err, data)  {
                     if (err) throw err                     write(path + "/public/js/services.js", parse(data, project));
                  }
               );
            }
         );
         ...
         mkdir(path + "/public/css", function()  {
               fs.readFile(bundle + "/css/style.styl", "utf8", function(err, data)  {
                     if (err) throw err                     write(path + "/public/css/style.styl", data);
                  }
               );
            }
         );
   ...
   mkdir(path + "/modules/session-store/", function()  {
         fs.readFile(bundle + "/modules/session-store/index.js", "utf8", function(err, data)  {
               if (err) throw err               write(path + "/modules/session-store/index.js", data);
            }
         );
      }
   );
   mkdir(path + "/routes", function()  {
         fs.readFile(bundle + "/routes/index.js", "utf8", function(err, data)  {
               if (err) throw err               write(path + "/routes/index.js", data);
            }
         );
         fs.readFile(bundle + "/routes/api.mus", "utf8", function(err, data)  {
               if (err) throw err               write(path + "/routes/api.js", parse(data, project));
            }
         );
      }
   );
...
function mkdir(path, fn)  {
   mkdirp(path, 493, function(err)  {
         if (err) throw err         console.log("   [36mcreate[0m : " + path);
         fn && fn();
      }
   );
}
...
function emptyDirectory(path, fn)  {
   fs.readdir(path, function(err, files)  {
         if (err && "ENOENT" != err.code) throw err         fn(! files || ! files.length);
      }
   );
}
;
