...
function startServers(callback)  {
   ...
   var corsValues =  {
      ...
      /_config/cors/methods:"PROPFIND, PROPPATCH, COPY, MOVE, DELETE, " + "MKCOL, LOCK, UNLOCK, PUT, GETLIB, VERSION-CONTROL, CHECKIN, " + "CHECKOUT, UNCHECKOUT, REPORT, UPDATE, CANCELUPLOAD, HEAD, " + "OPTIONS, GET, POST", 
      /_config/cors/headers:"Cache-Control, Content-Type, Depth, Destination, " + "If-Modified-Since, Overwrite, User-Agent, X-File-Name, " + "X-File-Size, X-Requested-With, accept, accept-encoding, " + "accept-language, authorization, content-type, origin, referer"   }
;
