! ✖ / env;
node;
var Promise = require("bluebird"), optimist = require("optimist"), getGlyphs = require("./lib/getGlyphs"), libFontAwesome = require("./index");
var argv = optimist.usage("Usage:
  $0 --sprites
  $0 --color white --no-png
  $0 --color black --no-svg
  $0 --sprites --color black,white --optipng
  $0 --list").describe("sizes", "Provide comma separated sizes to generate").describe("color", "Provide color or colors, e.g. --color black,white").describe("sprites", "Generate sprites.svg to use SVG as icons (http://tympanus.net/codrops/2013/11/27/svg-icons-ftw/)").describe("nopadding", "Do not add padding for PNG pixel perfection").describe("png", "Generate PNG files").describe("optipng", "Run each file through optipng (need to be installed)").describe("svg", "Generate SVG files").describe("icons", "Optional list of icons to generate, e.g. --icons phone,star").describe("dest", "Output folder").describe("list", "List available icons").describe("help", "Show this help screen").default( {
