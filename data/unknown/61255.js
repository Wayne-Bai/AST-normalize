...
var argv = optimist.usage("Usage: $0 -T [types] --reporter [reporter] --timeout [timeout]").default( {
      types:"unit,component", 
      reporter:"spec", 
      timeout:6000   }
).describe("types", "The types of tests to run, separated by commas. E.g., unit,functional,acceptance").describe("reporter", "The mocha test reporter to use.").describe("timeout", "The mocha timeout to use per test (ms).").boolean("bail").describe("bail", "Bail on first failure").boolean("verbose").describe("verbose", "Verbose output").boolean("help").alias("types", "T").alias("timeout", "t").alias("reporter", "R").alias("bail", "b").alias("help", "h").argv;
var mocha = new Mocha( {
