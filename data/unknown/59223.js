...
test("Database rewrite", function(t, type)  {
      ...
      request( {
            ...
            json:true         }, 
         function(er, res)  {
            if (er) throw er            t.equal(res.statusCode, 200, "Hit the _db rewrite");
...
test("Design doc rewrite", function(t, type)  {
      ...
      request( {
            ...
            json:true         }, 
         function(er, res)  {
            if (er) throw er            t.equal(res.statusCode, 200, "Hit the _ddoc rewrite");
               ...
               function(er, res)  {
                  ...
                  request( {
                     ...
                     function(er, res)  {
                        ...
                        t.equal(res.body._id, "_design/" + type, "_ddoc/// got this design document: " + type);
                        request( {
                              url:ddoc + "/attachment.html", 
                              json:true                           }, 
                           function(er, res)  {
                              if (er) throw er                              t.equal(res.statusCode, 404, "Hit the _ddoc/attachment.html rewrite");
...
test("CouchDB rewrite", function(t, type)  {
      ...
      request( {
            ...
            json:true         }, 
         function(er, res)  {
            if (er) throw er            t.equal(res.statusCode, 200, "Hit the _couchdb rewrite");
            t.equal(res.body.couchdb, "Welcome", "_couchdb rewrite goes to CouchDB");
            request( {
                  url:couch + "/" + TEST_DB, 
                  json:true               }, 
               function(er, res)  {
                  if (er) throw er                  t.equal(res.statusCode, 200, "Hit the _couchdb/db rewrite");
