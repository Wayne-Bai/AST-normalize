! ✖ / env;
node;
var path = require("path"), read = require("read"), permissions = require("./permissions.js"), config = require("./config.js"), models = require("./models.js"), optimist = require("optimist"), API = require("./api"), utils = require("./utils.js"), console = require("./ext-console.js");
if (! module.parent)  {
   var api = new API();
   var args = optimist.argv, help = "Usage: node manage.js <command> [options]
...
;
      var askUsername = function(callback)  {
         read( {
               prompt:"Username/email address: "            }, 
            function(err, answer, isDefault)  {
               if (err)  {
                  utils.exitCallback();
               }
               username = answer;
