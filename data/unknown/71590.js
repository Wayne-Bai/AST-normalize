...
suites.add("manipulation - html independent", "jquery.html",  {
      setup:function()  {
         return "<div class="foo"><div id="bar">bat<hr>baz</div> </div>" + "<div class="foo"><div id="bar">bat<hr>baz</div> </div>" + "<div class="foo"><div id="bar">bat<hr>baz</div> </div>" + "<div class="foo"><div id="bar">bat<hr>baz</div> </div>" + "<div class="foo"><div id="bar">bat<hr>baz</div> </div>" + "<div class="foo"><div id="bar">bat<hr>baz</div> </div>";
      }, 
