...
function median(values)  {
   values.sort(function(a, b)  {
         return a.metrics.httpTrafficCompleted - b.metrics.httpTrafficCompleted;
      }
   );
...
switch(cli.action) {
   case "server":
         ...
         ["database", "collection", "ui_title_text", "ui_title_link", "server_theme", "chart_theme", "runs"].forEach(function(arg)  {
