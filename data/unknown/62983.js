! ✖ / env;
node;
var log = console.log, Spade = require("../"), tclients = 20, requests = 64 * 1024, list = [], rc = requests, cc = tclients, stime = 0, ttime = 0, long_string = "ABCDEFGHILMNOPQRSTUVZJKXYW0123456789abcdefghilmnopqrstuvzjkxyw0123456789", spade_opt =  {
   hiredis:! ! true, 
   security: {
      127.0.0.1:6379: {
         db:- 1      }} }
...
;
var add = function()  {
   var s = Spade(spade_opt), commands = s.commands;
