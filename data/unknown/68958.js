...
;
var fs = require("fs"), cc = require("config-chain"), beautify = require("../index"), mkdirp = require("mkdirp"), nopt = require("nopt"), path = require("path"), knownOpts =  {
   indent_size:Number, 
   indent_char:String, 
   eol:String, 
   indent_level:Number, 
...
function processInputSync(filepath)  {
   var data = "", config = this.cfg, outfile = config.outfile, input;
