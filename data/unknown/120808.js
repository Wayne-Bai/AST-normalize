...
if (b.argv._[0] === "help" && b.argv._[1] === "advanced" || b.argv.h || b.argv.help === "advanced")  {
   return fs.createReadStream(__dirname + "/advanced.txt").pipe(process.stdout).on("close", function()  {
         process.exit(1);
      }
   );
}
if (b.argv._[0] === "help" || b.argv.h || b.argv.help || process.argv.length <= 2 && process.stdin.isTTY)  {
