...
function getPage()  {
   request(url, function(error, response, body)  {
         if (error) return console.log(error, "Couldn't find page!")         if (! error && response.statusCode == 200)  {
            data.html = body;
            return getStats();
         }
      }
...
function contributionCounts()  {
   ...
   if (data.count === "0")  {
      return console.log("---
✗ Grey! " + username + " with " + data.count, day + "!
---");
   }
    else  {
      var greens =  {
...
;
      ...
      return console.log("---
✔︎ Green " + userFill + "! " + username + " with " + data.count, day + "!
---");
   }
}
;
