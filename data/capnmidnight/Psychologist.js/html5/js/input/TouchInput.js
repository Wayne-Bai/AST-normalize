function TouchInput(name, buttonBounds, commands, socket, oscope, DOMElement){
    ...
    ButtonAndAxisInput.call(this, name, commands, socket, oscope, 1, TouchInput.AXES);
...
ButtonAndAxisInput.inherit(TouchInput);