 ...
 * @version 1.1
 **/
LIB("mxext/mmanager", ["magix/magix", "magix/event"], function(Magix, Event) {
    /*
        #begin mm_fetchall_1#
        LIB('testMM',["mxext/mmanager","mxext/model"],function(MM,Model){
        #end#
 ...
 * @author 行列
 */
LIB('mxext/model', ['magix/magix'], function(Magix) {
 ...
 * @author 行列
 */
LIB('mxext/view', ["magix/magix", "magix/view", "magix/router"], function(Magix, View, Router) {
    var WIN = window;
var ResCounter = 0;
var SafeExec = Magix.safeExec;
var Has = Magix.has;
