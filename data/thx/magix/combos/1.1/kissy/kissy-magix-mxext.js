 ...
 * @version 1.1
 */
LIB.add('magix/view', function(S, Magix, Event, Body, IO) {
 ...
 * @version 1.1
 **/
LIB.add("mxext/mmanager", function(S, Magix, Event) {
    /*
        #begin mm_fetchall_1#
 ...
 * @author 行列
 */
LIB.add('mxext/model', function(S, Magix) {
 ...
 * @author 行列
 */
LIB.add('mxext/view', function(S, Magix, View, Router) {
    var WIN = window;
var ResCounter = 0;
var SafeExec = Magix.safeExec;
var Has = Magix.has;
