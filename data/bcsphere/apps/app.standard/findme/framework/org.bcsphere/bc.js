...
*/
	  ...
	  var Service = BC.Service = GATTEntity.extend({
		...
		function onDeviceReady(){
			...
			BC.bluetooth.addSystemListener('listenerdeviceconnected', function(arg){
				//alert(JSON.stringify(arg));
				//alert(BC.bluetooth.devices[arg.deviceAddress].deviceAddress);
				//BC.bluetooth.devices[arg.deviceAddress].isConnected = true;
				BC.bluetooth.dispatchEvent("listenerdeviceconnected",arg);
				//BC.bluetooth.devices[arg.deviceAddress].dispatchEvent("listenerdeviceconnected");
			});

			BC.bluetooth.addSystemListener('listenerdevicedisconnected', function(arg){
				//BC.bluetooth.devices[arg.deviceAddress].isConnected = false;
				BC.bluetooth.dispatchEvent("listenerdevicedisconnected",arg);
				//BC.bluetooth.devices[arg.deviceAddress].dispatchEvent("listenerdevicedisconnected");
			});
