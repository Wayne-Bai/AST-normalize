    ...
    $.widget( "ui.selectmenu", {
        ...
        _drawButton: function() {
            ...
            this.buttonText = $( '<span />', {
                ...
                html: this.options.format((selectedOption.text() || '&nbsp;'), selectedOption.eq(0))
            })
        ...
        _drawMenu: function() {
            ...
            this.menuWrap = $( '<div />', {
                ...
                width: this.options.menuWidth ||(( this.options.dropdown ) ? this.button.outerWidth() : this.buttonText.width() + parseFloat( this.buttonText.css( "padding-left" ) ) || 0 + parseFloat( this.buttonText.css( "margin-left" ) ) || 0)
            })
                .append( this.menu )
        ...
        _renderItem: function( ul, item) {
            ...
            li.append( $( "<a />", {
                html: this.options.format(item.label, item.element),
                href: '#'
            })
            );
        ...
        _setSelected: function( item ) {
            // update button text
            this.buttonText.html( this.options.format(item.label, item.element) );
            // change ARIA attr
