	...
	XOS_GlobalMouseListener.prototype.initEventListeners = function () 
	{	
		var html = document.getElementsByTagName('html')[0];
		
		if( DEVICE_WITH_TOUCH_EVENTS )
		{		
			CreateEventListener ( html , "touchstart" , this.onTouchStart , this , true ); // con true stabilisco che l'evento deve essere preso a partire dal nodo superiore
	...
	XOS_GlobalMouseListener.prototype.startSnap = function ( _snapValue )
	{
	...
	// viene chiamato ogni mezzo secondo

	XOS_GlobalMouseListener.prototype.lookForMouseMovePause = function (_e)
	{				
	...
	XOS_GlobalMouseListener.prototype.onMouseClick = function (_e)
	{				
	}
	
	XOS_GlobalMouseListener.prototype.onMouseDoubleClick = function (_e)
	{		
	}
	
	XOS_GlobalMouseListener.prototype.onStartDrag = function (_e)
	{
	...
	XOS_GlobalMouseListener.prototype.onEndDrag = function (_e)
	{
	...
	XOS_GlobalMouseListener.prototype.onDrag = function (_e)
	{	
...
*/
	...
	XOS_GlobalMouseListener.prototype.onMouseWheel = function (_e)
	{		
	}
	
	XOS_GlobalMouseListener.prototype.onMouseMoveStartPause = function ( _e )
	{
		if(this.isDragAction) this.onStartPauseDrag(_e);
	}
	
	XOS_GlobalMouseListener.prototype.onMouseMoveEndPause = function ( _e )
	{
		if(this.isDragAction) this.onEndPauseDrag(_e);
	}
		
	XOS_GlobalMouseListener.prototype.onStartPauseDrag = function (_e)
	{	
		if( this.objectTarget && this.objectTarget.onGlobalMouseDragStartPause )this.objectTarget.onGlobalMouseDragStartPause(_e);	
	}
		
	XOS_GlobalMouseListener.prototype.onEndPauseDrag = function (_e)
	{	
		if( this.objectTarget && this.objectTarget.onGlobalMouseDragEndPause )this.objectTarget.onGlobalMouseDragEndPause(_e);	
	}
	
	XOS_GlobalMouseListener.prototype.onMouseDown = function ( _e )
	{		
	...
	XOS_GlobalMouseListener.prototype.onMouseUp = function ( _e )
	{
	...
	XOS_GlobalMouseListener.prototype.onMouseMove = function ( _e)
	{
	...
	XOS_GlobalMouseListener.prototype.startDrag = function (_e)
	{
		this.isDragAction=true;		
		this.onStartDrag( null );			
	}

	XOS_GlobalMouseListener.prototype.onTouchStart = function ( _e )
	{			
		this.onMouseDown(_e);
	}
	
	XOS_GlobalMouseListener.prototype.onTouchMove = function ( _e )
	{	
		this.onMouseMove(_e);
	}
		
	XOS_GlobalMouseListener.prototype.onTouchEnd = function ( _e )
	{
		if( _e.targetTouches.length == 0 ) this.onMouseUp(_e);
	}
		
	XOS_GlobalMouseListener.prototype.onTouchCancel = function ( _e )
	{		
	}
	
	XOS_GlobalMouseListener.prototype.resetState = function ( )
	{	
		this.isDragAction=false;
		this.isSnapped = false;
		this.isMouseButtonPressed = false;
	...
	XOS_GlobalMouseListener.prototype.eventLocationToPoint = function ( _e , _point2D )
	{
		if( IS_IOS )
		{
	...
	XOS_GlobalMouseListener.prototype.distanceFromPoints = function( _pt1 , _pt2 )
	{
	...
	XOS_GlobalMouseListener.prototype.calculateSnapToAngle = function ()
	{
	...
	// per creare oggetti draggabili generici
	
	XOS_GlobalMouseListener.prototype.elementChildrenToDraggableElements = function ( _elementContainer )
	{		
	...
	XOS_GlobalMouseListener.prototype.createDraggableElement = function ( _elementToDrag )
	{
	...
	XOS_GlobalMouseListener.prototype.onMouseDownOnDraggableElement = function ( _e  )
	{
	...
	XOS_GlobalMouseListener.prototype.onGlobalMouseDrag = function ( _e )
	{
