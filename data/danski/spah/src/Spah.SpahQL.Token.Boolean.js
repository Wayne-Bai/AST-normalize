/**
 * class Spah.SpahQL.Token.Boolean < Spah.SpahQL.Token.Simple
 *
 * A simple token wrapping a boolean true or false.
 **/
 
Spah.classExtend("Spah.SpahQL.Token.Boolean", Spah.SpahQL.Token.Simple, {
  ...
  /**
   * Spah.SpahQL.Token.Boolean.parseAt(i, query) -> Array\[resumeIndex, foundToken\] or null
   *
