...
if (!window.af || typeof (af) !== "function") {
    ...
    var af = (function (window) {
        ...
        var $afm = function (toSelect, what) {
            ...
            if (!toSelect) {
                return this;
            } else if (toSelect instanceof $afm && what == undefined) {
                return toSelect;
        ...
        function _selectorAll(selector, what) {
            try {
                return classSelectorRE.test(selector) ? what.getElementsByClassName(RegExp.$1) :
            ...
            toggle: function (show) {
                ...
                for (var i = 0; i < this.length; i++) {
                    if (window.getComputedStyle(this[i])['display'] !== "none" || (show !== undefined && show2 === false)) {
                        ...
                        this[i].style.display = this[i].getAttribute("afmOldStyle") != undefined ? this[i].getAttribute("afmOldStyle") : 'block';
                        this[i].removeAttribute("afmOldStyle");
                    }
                }
                return this;
    ...
    window.$  = af; //we are greedy  - we expect $ to be App Framework
