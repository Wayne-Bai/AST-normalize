...
function  WWHControlEntry_GetHTML()
{
  ...
  if (this.mbEnabled)
  {
    ...
    // Display control
    //
  // BEGIN_GUIDWIRE_EDIT to set style attribute to insure small image height
...
function  WWHControls_Initialize()
{
  ...
  {
// for guidewire WE COMMENT THIS OUT SO THAT EMAIL IS ALWAYS AVAILABLE EVEN IF EMPTY STRING
...
function  WWHControls_SwitchToNavigation(ParamTabName)
{
  ...
  // BEGIN_GUIDEWIRE_EDIT ORIGINAL HAD AT END... SHOULD WE HAVE IT AND FORGOT TO MERGE IN? WWHFrame.WWHBrowser.fRestoreEscapedSpaces(VarDocumentURL);
...
// BEGIN_GUIDEWIRE_EDIT this change the basic logic of "bookmark button" to instead open and close our link to this page window
...
{
// BEGIN_GUIDEWIRE_EDIT add a third array element to this variable for our link to this page URL, honestly I do not remember why we do this
...
// BEGIN_GUIDEWIRE_EDIT for link to this page, set the URL to our link to this page URL (and add a third array element with a dupe of our URL for some crazy reason, may not be necessary
