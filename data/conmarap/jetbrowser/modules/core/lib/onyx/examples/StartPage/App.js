var bookmarks = [
	{title: "Cinux Blog", url: "http://mycinux.blogspot.com/"},
	{title: "OSArena", url: "http://www.osarena.net/"},
...
enyo.kind({
	...
	components: [
		{kind: "FittableRows", classes: "enyo-fit", onload: "onload", components: [
	...
	onload: function(inSender) {
		this.goto("file:///home/apostolou/Desktop/StartPage/webkitpage.html");
		this.toggleBookmarks(bookmarksButton);
	},
	goTap: function() {
